class AlarmClock:
    ...
    def __init__(self, time, time_change_YN, alarm_status, alarm_time, alarm_change_YN):
        self.time = time  # default time # one_display_time = AlarmClock
        self.time_change_YN = time_change_YN  # two_change_time = AlarmClock
        # three_alarm_status = AlarmClock # whether the alarm is on or off =['on','off']
        self.alarm_status = alarm_status # alarm time set # four_alarm_time = AlarmClock
        self.alarm_time = alarm_time  # four_alarm_time.time_of_alarm()  #
